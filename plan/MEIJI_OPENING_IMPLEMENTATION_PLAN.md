...
- A3「戊辰戦争の空間展開」を実装した。鳥羽・伏見、江戸、長岡、会津若松、箱館・五稜郭の代表点のみを示し、進軍路・戦線・藩境のLineStringは作らない。Data Audit / Style Audit は passed。2026-09-26、GitHub Pages上で表示・ラベル・popup・pan / zoomをHuman Visual Auditし、passedとして `published` に更新した。
...
- JH10本文とA3のData / Style / Human Visual Auditまで完了した。A4はデータ品質理由で見送りを記録しており、JH10を完了扱いとする。
